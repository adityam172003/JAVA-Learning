...
class Myclass {
	...
	public static void main(String[] args) {
		...
		// This is new concept since 1.8 stream class 
		IntStream ist = str1.chars();
		ist.forEach(e-> System.out.print((char)e));

		// IntStream istf = ist.filter(e ->  (char)e == 'A' );
		// istf.toString();

		String spl = "hii,this,is,aditya";
		
		String []arr = spl.split(",");
		
		System.out.println(arr.length);
		for(var i : arr)System.err.println(i);
