...
public class file_6_String_Methods {
	...
	public static void main(String[] args) {
		...
		String s1 = String.valueOf(100); // this function internally calls toString method 
	   ...
	   // 10 ] string modification function 
			   ...
			   // intern method it is related t string present in pool or not 
			   // if present in pool then its reference is returned else it is 
			   // created and its reference is returnd
