...
/*
 		...
 		Lots of usefull methods are present in the java.util.Arrays class you can utilize it 
		refer the tutorials point for that purpose 

		-------------------------------------------------------------------------
		REFERENCE : https://www.tutorialspoint.com/java/util/java_util_arrays.htm

 		-------------------------------------------------------------------------
		// open the Arrays class present int the util package and observe 
		which algorithms are used internally 
...
public class Arrayss
{
	...
	for(var i : arr)System.err.print(i+" ");
	System.err.println();
	...
	// it requires the Wrapper class object 
	List<Integer> lst  = Arrays.asList(arr); // object of ArrayList will be returned here 
	...
	int []arr2 = new int[]{2,4,45,1,3};

	// parallelPrifix 

	Arrays.parallelPrefix(arr2, (x1, y) -> x1 + y);



	Arrays.sort(arr2); // we need to sort the array if we have to sort it 
	System.out.println(Arrays.binarySearch(arr2,1)); //  To use binary search array must be sorted 
